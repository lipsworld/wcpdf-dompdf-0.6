<?php 
// We can't use these folders because dompdf 0.8 has a slightly different format for the font cache file...
// if ( function_exists('WPO_WCPDF') ) {
// 	define("DOMPDF_TEMP_DIR", WPO_WCPDF()->main->get_tmp_path('dompdf') );
// 	define("DOMPDF_FONT_DIR", trailingslashit( WPO_WCPDF()->main->get_tmp_path('dompdf') ) ); //needs trailing slash!
// 	define("DOMPDF_FONT_CACHE", WPO_WCPDF()->main->get_tmp_path('dompdf') );
// }
